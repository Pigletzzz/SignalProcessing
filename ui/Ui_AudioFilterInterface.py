...
class Ui_AudioFilterInterface(object):
    def setupUi(self, AudioFilterInterface):
        ...
        self.sampleRateLabel = BodyLabel(self.SimpleCardWidget_2)
        ...
        self.formLayout.setWidget(2, QtWidgets.QFormLayout.FieldRole, self.sampleRateLabel)
        ...
        self.formLayout.setWidget(3, QtWidgets.QFormLayout.FieldRole, self.cutoffLabel)
    ...
    def retranslateUi(self, AudioFilterInterface):
        ...
        self.BodyLabel_3.setText(_translate("AudioFilterInterface", "采样率"))
