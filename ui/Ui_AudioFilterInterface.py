...
class Ui_AudioFilterInterface(object):
    def setupUi(self, AudioFilterInterface):
        ...
        AudioFilterInterface.resize(921, 669)
        ...
        self.formLayout.setWidget(0, QtWidgets.QFormLayout.FieldRole, self.BodyLabel_4)
        self.BodyLabel_5 = BodyLabel(self.SimpleCardWidget_2)
        self.BodyLabel_5.setObjectName("BodyLabel_5")
        self.formLayout.setWidget(1, QtWidgets.QFormLayout.FieldRole, self.BodyLabel_5)
        self.BodyLabel_6 = BodyLabel(self.SimpleCardWidget_2)
        self.BodyLabel_6.setObjectName("BodyLabel_6")
        self.formLayout.setWidget(2, QtWidgets.QFormLayout.FieldRole, self.BodyLabel_6)
        ...
        self.BodyLabel_8 = BodyLabel(self.SimpleCardWidget_2)
        self.BodyLabel_8.setObjectName("BodyLabel_8")
        self.formLayout.setWidget(3, QtWidgets.QFormLayout.FieldRole, self.BodyLabel_8)
    ...
    def retranslateUi(self, AudioFilterInterface):
        ...
        self.BodyLabel_4.setText(_translate("AudioFilterInterface", "Body label"))
        self.BodyLabel_5.setText(_translate("AudioFilterInterface", "Body label"))
        self.BodyLabel_6.setText(_translate("AudioFilterInterface", "Body label"))
        self.BodyLabel_7.setText(_translate("AudioFilterInterface", "截止频率"))
        self.BodyLabel_8.setText(_translate("AudioFilterInterface", "Body label"))
