...
class Ui_FIRFormInterface(object):
    def setupUi(self, FIRFormInterface):
        ...
        self.cutoffEdit = LineEdit(FIRFormInterface)
        self.cutoffEdit.setObjectName("cutoffEdit")
        self.formLayout.setWidget(3, QtWidgets.QFormLayout.FieldRole, self.cutoffEdit)
        self.BodyLabel = BodyLabel(FIRFormInterface)
        self.BodyLabel.setObjectName("BodyLabel")
        self.formLayout.setWidget(4, QtWidgets.QFormLayout.LabelRole, self.BodyLabel)
        self.windowsBox = ComboBox(FIRFormInterface)
        self.windowsBox.setObjectName("windowsBox")
        self.formLayout.setWidget(4, QtWidgets.QFormLayout.FieldRole, self.windowsBox)
