...
class Ui_IIRFormInterface(object):
    def setupUi(self, IIRFormInterface):
        ...
        self.protoTypeBox = ComboBox(IIRFormInterface)
        self.protoTypeBox.setObjectName("protoTypeBox")
        self.formLayout.setWidget(8, QtWidgets.QFormLayout.FieldRole, self.protoTypeBox)
    ...
    def retranslateUi(self, IIRFormInterface):
        ...
        self.BodyLabel_3.setText(_translate("IIRFormInterface", "通带低频率"))
        self.BodyLabel_5.setText(_translate("IIRFormInterface", "通带高频率"))
        self.BodyLabel_4.setText(_translate("IIRFormInterface", "阻带低频率"))
