...
class Ui_FilterDesignerInterface(object):
    def setupUi(self, FilterDesignerInterface):
        ...
        self.amplitudePlotWidget = SimpleCardWidget(self.SimpleCardWidget_2)
        self.amplitudePlotWidget.setObjectName("amplitudePlotWidget")
        self.horizontalLayout_3.addWidget(self.amplitudePlotWidget)
        self.phasePlotWidget = SimpleCardWidget(self.SimpleCardWidget_2)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Expanding)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.phasePlotWidget.sizePolicy().hasHeightForWidth())
        self.phasePlotWidget.setSizePolicy(sizePolicy)
        self.phasePlotWidget.setObjectName("phasePlotWidget")
        self.horizontalLayout_3.addWidget(self.phasePlotWidget)
